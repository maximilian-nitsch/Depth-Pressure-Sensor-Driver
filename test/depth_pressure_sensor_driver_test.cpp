 ...
 */
std::shared_ptr<keller::KellerSerialInterfaceEmulator> pSerial =
    std::make_shared<keller::KellerSerialInterfaceEmulator>("emulated/port",
                                                            115200);
std::shared_ptr<keller::KellerSensorDriver> pKellerSensorDriver =
    std::make_shared<keller::KellerSensorDriver>(pSerial, 5, 0.0, 0.0);
